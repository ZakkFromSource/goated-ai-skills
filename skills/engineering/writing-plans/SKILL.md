...
- code-refinement after implementation when non-trivial changed code should be simplified without behavior changes before review gates
...
5. Write executable steps:
   ...
   - Include closeout steps: `code-refinement` when non-trivial changed code should be simplified without behavior changes, standards/spec review, security review when relevant, documentation sync, and final verification.
