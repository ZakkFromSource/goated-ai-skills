...
- `code-refinement` - refines recently changed code after implementation while preserving behavior and avoiding unrelated churn; use it as a run-or-explicit-skip gate for non-trivial code-producing work.
