...
| PRD or spec | Defines product intent, requirements, scope, user stories, or acceptance criteria. | `docs/prds/`, `issues/prd-*.md`, `docs/prd.md` | Keep current status separate from aspirational scope when possible. |
