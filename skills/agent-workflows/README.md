...
Skills in this category define reusable operating patterns for installed agent workflows: skill routing, session starts, target-project context maps, context calibration, standards calibration, instruction integration, multi-session uncertainty navigation, handoffs, and skill creation and porting.
...
- `wayfinder` - advances a visible decision frontier across sessions and hands settled evidence to a named planning destination without executing production work.
