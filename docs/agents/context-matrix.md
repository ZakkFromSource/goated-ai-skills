...
| `tickets/archive/015-*.md` through `tickets/archive/020-*.md`, active `tickets/021-*.md` through `tickets/024-*.md`, and `tickets/selective-upstream-skill-adoption-order.md` | Accepted high-confidence adoption, invocation investigation, and active-domain-modeling evaluation slices. | Phase A is accepted with residual risk; Tickets 021 through 024 remain planned. | Tickets 022 and 024 require explicit maintainer go decisions. Ticket 013 is the maintainer-selected next slice before further experiment work. |
