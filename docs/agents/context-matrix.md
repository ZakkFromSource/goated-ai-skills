...
| `tickets/archive/015-*.md` through `tickets/archive/017-*.md`, active `tickets/018-*.md` through `tickets/024-*.md`, and `tickets/selective-upstream-skill-adoption-order.md` | High-confidence adoption, invocation investigation, and active-domain-modeling evaluation slices. | Tickets 015 through 017 are complete; remaining slices are active planned delivery. | Tickets 022 and 024 require explicit go decisions; coordinate all overlapping validator edits with active Ticket 013. |
