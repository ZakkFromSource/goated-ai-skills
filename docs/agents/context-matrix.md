...
| `issues/*.md` excluding `issues/archive/` and PRDs | Planned future V1 implementation slices and final acceptance pass. | Active issue handoffs. | As of 2026-05-22, active handoffs are `021` and `030` through `032`; read the current issue before implementing or reviewing that slice. |
